...
class File extends ParentComponent {
  ...
  render () {
    ...
    if (this.props.type === 'training') {
      elem = <a className={this.props.cur ? 'selected' : ''} onClick={() => controller.changeFile(f.name, f.type, 'training')} s-val={f.type + '.' + f.name}>{capitalize(f.type) + '.' + capitalize(f.name) }</a>
    } else {
      elem = <a ref={this.element} className={this.props.cur ? 'selected' : ''} bubble-name={capitalize(f.type) + '.' + capitalize(f.beauty)} bubble={f.desc} onClick={() => controller.changeFile(f.name, f.type, 'response')} s-val={f.type + '.' + f.name}>{capitalize(f.type) + '.' + capitalize(f.beauty)}</a>
    }
    return (
      <>
        {elem}
...
class LeftMenu extends ParentComponent {
  render () {
    ...
    if (this.props.files) {
      ...
      i++;
      this.props.files.training.forEach(f => {
        let cur = false;
        if ((f.type + '.' + f.name) === this.props.filename) {
          cur = true;
        }
        files.push(
          <File file={f} type={'training'} key={i}/>
        );
        i++;
      });
      files.push(<h2 key={i}>Responses</h2>);
      i++;
      this.props.files.response.forEach(f => {
        let cur = false;
        if ((false.type + '.' + f.name) === this.props.filename) {
          cur = true;
        }
        files.push(
          <File file={f} type={'response'} key={i}/>
        );
        i++;
      });
    } else {
    ...
    return (
      <nav>
        <div className="search" id="search" search='simple' s-con='filecontainer'>
        ...
        <div className="but">
          <a id="savebut" onClick={controller.save}>
            Save
            <img src='/pic/load.gif' />
          </a>
        </div>
      ...
      <div className="topbar">
        ...
        <div>
          ...
          <label className="switch">
            <input onChange={controller.toggleAutosave} type="checkbox" id="i-autosave"/>
  ...
  render () {
    return (
      <>
        ...
        <span className="info-but" id="info-but" doc='' onClick={function(event){event.stopPropagation(); controller.showDoc(event, true)}}>
          <i className="fas fa-info" doc=''></i>
        </span>
        <span className="back-but">
          <a onClick={controller.backToHome} className="fas fa-chevron-left"></a>
        </span>
      </>
    );
  }
...
class RightMenu extends ParentComponent {
  render () {
    let title = null;
    let params = null;
    if (this.props.cat === 'response') {
      ...
      if (this.props.params === null) {
        ...
        params = this.props.params.map((param, index) => (
          <strong key={index} onClick={() => controller.clickParam(param)} s-val={ param }>{ param }</strong>
        ));
      }
    } else {
      ...
      if (this.props.entities === null) {
        ...
        params = this.props.entities.map((param, index) => (
          <strong key={index} onClick={() => controller.clickEntity(param)} s-val={ param }>{ param }</strong>
        ));
      }
    }
    ...
    return(
      <div className="rightmenu">
        <div className="search" id="search" search="simple" s-con='paramcontainer'>
          <input type="text" placeholder="Search..."/>
        </div>
  ...
  render () {
    return (
      <div className="infos" id="infos">
        <span>
          <div onClick={this.stopProp} doc=''>
            <h2 doc=''>Gimme some help</h2>
            <div doc=''>
              <button className="accordion" onClick={() => accordion.withAnim(event)}>Desc</button>
              <div className="panel">
                <p>
              ...
              <button className="accordion" onClick={() => accordion.withAnim(event)}>Text</button>
              <div className="panel">
                <p>
              ...
              <button className="accordion" onClick={() => accordion.withAnim(event)}>Media</button>
              <div className="panel">
                <p>
              ...
              <button className="accordion" onClick={() => accordion.withAnim(event)}>Link</button>
              <div className="panel">
                <p>
              ...
              <button className="accordion" onClick={() => accordion.withAnim(event)}>Btn</button>
              <div className="panel">
                <p>
              ...
              <button className="accordion" onClick={() => accordion.withAnim(event)}>Dropdown</button>
              <div className="panel">
                <p>
              ...
              <button className="accordion" onClick={() => accordion.withAnim(event)}>Clone</button>
              <div className="panel">
                <p>
              ...
              <button className="accordion" onClick={() => accordion.withAnim(event)}>Foreach in text</button>
              <div className="panel">
                <p>
              ...
              <button className="accordion" onClick={() => accordion.withAnim(event)}>Foreach for btn and dropdown</button>
              <div className="panel">
                <p>
              ...
              <button className="accordion" onClick={() => accordion.withAnim(event)}>Errors and Warnings</button>
              <div className="panel">
                <p>
                ...
                <ul>
                  <li>
                    "The character ' is forbidden as a delimiter use " instead" : this is a rule we added to be as clear as possible, when you write some text, you have to surround it with ""
                  </li>
                  <li>
                    "Attribute '...' doesn't exist in the current context" : this means a first level attribute is not valid
                  </li>
                  <li>
                    "Attribute '...' already exists" : this means a first level attribute is already present
                  </li>
                  <li>
                    "Property of '...' must be an array" : this means you must forgot the '-' character to start an array
                  </li>
                  <li>
                    "Unknown property '...' for '...'" : this means you are trying to add a not valid property
                  </li>
                  <li>
                    "Property '...' for '...' must be a string" : this means you made a new line without specified a text value you can just put "" if you don't want to provide text
                  </li>
                  <li>
                    "Property '...' for '...' cannot be a string" : this means you put text just after an attribute which should be an object or an array
                  </li>
                  <li>
                    "Attribute '...' must be an array and cannot be null" : this means you forgot to add value for a first level attribute
                  </li>
                  <li>
                    "Unexpected line" : this means you have an indentation problems
                  </li>
                  <li>
                    "Attribute '...' must be a string and cannot be an object or an array" : this means a first level attribute should be a string but is an object or an array
                  </li>
                  <li>
                    "Parameter '...' is not valid" : this means that a parameter between '{'{{ }}'}' is not in the list on the right
                  </li>
                  <li>
                    "Missing attribute '...' in '...'" : this is pretty clear but the line is not specified
                  </li>
                  <li>
                    "Unknown attribute '...' for '...'" : this is pretty clear but the line is not specified
                  </li>
                  <li>
                    "Parameter '...' is not valid" : this means a parameter from a foreach in dropdown or btn is not valid, check your foreach variables
                  </li>
                  <li>
                    "Malformed 'foreach' in text" : this means a foreach in text value is malformed, check your foreach syntax
                  </li>
                  <li>
                    "Unknown parameter '...' in 'foreach' in text" : this means the variable provided to a foreach in text is not present in the right list
                  </li>
                </ul>
              </div>
            </div>
...
class Page extends ParentComponent {
  constructor(props) {
    super(props);
    controller = new FileController(this, this.props.filename, this.props.cat, this.props.type, this.props.app);
  ...
  render () {
    return (
      <>
        <LeftMenu files={this.state.files} filename={this.state.type + '.' + this.state.filename}/>
        <main onClick={controller.clickClone}>
          <TopBar cat={this.state.cat} type={this.state.type} filename={this.state.type + '.' + this.state.filename}/>
          <Editor/>
        </main>
        <RightMenu params={this.state.parameters} cat={this.state.cat} entities={this.state.entities} />
